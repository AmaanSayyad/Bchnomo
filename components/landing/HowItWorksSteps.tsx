...
const STEPS = [
    {
        ...
        description: 'Connect your wallet and move assets into the Arbnomo hybrid vault. Your liquidity is secured on-chain while enabling millisecond execution speed.',
